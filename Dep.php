      ...
      <div id="wrapper">
        ...
        <div id="content-wrapper">
          ...
          <div class="container-fluid">
            ...
            <h1>Departments</h1>
            <hr>
            <p>Enter New Department (<font style="color:red;">Note: Fill in all the fields</font>)</p>
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    <div class="form-label-group" >
                      <input type="text" id="inputdep" class="form-control" name="fname" placeholder="Department Name" required="required" autofocus="autofocus">
                      <label for="inputdep">Department Name</label>
                    </div>
                  </div>
                </div>
														...
														<div class="col-lg-4">
															<div class="form-group">
																<div class="form-label-group" >
																<input type="submit" class="btn btn-primary btn-block" style="width:25%;"  id="submit_comment">
															</div>
														</div>
													</div>
